...
if [ "$1" = "fastapi" ] || [ "$1" = "uvicorn" ]; then
  ...
  python main.py asset_types add container meldingen.wfs.ProxyWfsProviderFactory 3 '/temp/path/to/icon.svg' https://api.data.amsterdam.nl/v1/wfs/huishoudelijkafval || true
fi
