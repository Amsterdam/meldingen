...
from meldingen.containers import jwks_client, user_repository
...
async def get_user(
    ...
    py_jwt: Annotated[PyJWT, Depends(PyJWT)],
...
async def authenticate_user(token: Annotated[str, Depends(oauth2_scheme)]) -> User:
