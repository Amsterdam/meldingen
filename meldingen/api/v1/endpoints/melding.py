...
from meldingen_core.actions.attachment import AttachmentTypes, MelderDownloadAttachmentAction
...
from meldingen.dependencies import (
    ...
    melder_download_attachment_action,
...
async def upload_attachment_melder(
    melding: Annotated[Melding, Depends(verify_token_and_retrieve_melding)],
    file: UploadFile,
    action: Annotated[MelderUploadAttachmentAction, Depends(melding_upload_attachment_action_form)],
...
async def melder_list_answers(
    melding: Annotated[Melding, Depends(verify_token_and_retrieve_melding)],
    action: Annotated[MeldingListQuestionsAnswersAction[Answer], Depends(melding_list_questions_and_answers_action)],
...
async def next_possible_states(
    melding_id: Annotated[int, Path(description="The id of the melding.", ge=1)],
    action: Annotated[MeldingGetPossibleNextStatesAction, Depends(melding_get_possible_next_states_action)],
