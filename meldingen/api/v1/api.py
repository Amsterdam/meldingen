...
from meldingen.api.v1.endpoints import attachment, classification, form, melding, static_form, user

api_router = APIRouter()
api_router.include_router(attachment.router, tags=["attachment"])
